...
public class Game {
	...
	public static void main(String args[]) {
		...
		game.setSquare(5, new InstantLosingSquare(game, 5));
		IDie die = new Die(6);
		game.play(die);
	}
	...
	public void movePlayer(int roll) {
		...
		Player player = players.remove(); // remove the player from the front
		players.add(player); // add him to back of the queue
